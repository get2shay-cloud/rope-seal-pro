    ...
    <section className="relative min-h-[100svh] flex items-center overflow-hidden">
      ...
      <div className="relative container mx-auto px-6 pt-20 sm:pt-24 pb-12 sm:pb-16">
        <div className="max-w-3xl text-white">
          ...
          <div className="mt-12 grid grid-cols-2 max-w-xs">
            {[
...
function Services() {
  const services = [
    { icon: Building2, title: "איטום וצביעה", desc: "טיפול יסודי בסדקים ובאזורי חדירת מים בקירות הבניין." },
    ...
    { icon: Target, title: "דיוק מקסימלי", desc: "גישה ישירה לכל נקודת בעיה בקיר, איתור מדויק של מקור הנזילה ופתרון נקודתי." },
  ];
  return (
      ...
      <div className="container mx-auto px-6 py-10 sm:py-14">
        <div className="text-center max-w-3xl mx-auto mb-6 sm:mb-8">
          ...
          <p className="mt-2 text-sm sm:text-base text-muted-foreground">
            ביצוע עבודות איטום ושיקום מעטפת עבור חברות הבנייה המובילות בישראל
          </p>
        </div>
