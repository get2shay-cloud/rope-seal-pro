    ...
    <section className="relative min-h-[100svh] flex items-center overflow-hidden">
      <div className="absolute inset-0">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(270deg, oklch(0.17 0.1 258 / 0.94) 0%, oklch(0.19 0.11 258 / 0.82) 40%, oklch(0.22 0.12 258 / 0.6) 75%, oklch(0.24 0.13 258 / 0.45) 100%)",
          }}
        />
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, oklch(0.16 0.09 258 / 0.35) 0%, oklch(0.16 0.09 258 / 0.1) 50%, oklch(0.16 0.09 258 / 0.45) 100%)",
          }}
        />
      </div>
      ...
      <div className="relative container mx-auto px-6 pt-32 pb-20">
        <div className="max-w-3xl text-white">
          ...
          <p className="mt-6 text-lg sm:text-xl text-white/85 leading-relaxed max-w-2xl">
            צוות מקצועי של טכנאי גובה מוסמכים, עם מעל עשור של ניסיון באיטום ושיקום מבנים.
